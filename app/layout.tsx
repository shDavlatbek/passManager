...
const themeBootstrap = `(function(){try{var t=localStorage.getItem('vaulthaus.theme');if(t!=='dark'&&t!=='light'){t='light';}var d=document.documentElement;d.dataset.theme=t;d.style.colorScheme=t;}catch(e){}})();`;
